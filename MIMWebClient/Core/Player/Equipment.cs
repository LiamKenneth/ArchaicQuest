    ...
    public class Equipment
    {
        ...
        public static string DisplayEq(Player player, Equipment eq)
        {
            ...
            displayEquipment.Append("<table>")
               .Append("<tr><td style='width:175px;'>").Append("<i class='ra ra-fw ra-torch'></i> Light").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Light)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-diamond ra ra-fw'></i> Finger").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Finger)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-diamond ra ra-fw'></i> Finger").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Finger2)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-gem-pendant ra ra-fw'></i> Neck").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Neck)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-gem-pendant ra ra-fw'></i> Neck").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Neck2)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-nuclear ra ra-fw'></i> Face").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Face)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-helmet ra ra-fw'></i> Head").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Head)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Torso").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Torso)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Legs").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Legs)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class=' ra-boot-stomp ra ra-fw'></i> Feet").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Feet)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class=' ra-hand ra ra-fw'></i> Hands").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Hands)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Arms").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Arms)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Body").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Body)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Waist").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Waist)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Wrist").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Wrist)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-vest ra ra-fw'></i> Wrist").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Wrist2)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-sword ra ra-fw'></i> Wielded").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Wielded)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-shield ra ra-fw'></i> Shield").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Shield)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class=' ra-round-bottom-flask ra ra-fw'></i> Held").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Held)).Append("</td></tr>")
                .Append("<tr><td>").Append("<i class='ra-fluffy-swirl ra ra-fw'></i> Floating").Append("</td>").Append("<td>").Append(ReturnEqName(player, eq.Floating)).Append("</td></tr>").Append("</table");
