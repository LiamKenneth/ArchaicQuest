...
namespace MIMEngine.Core.PlayerSetup
{
    public class PlayerRace
    {
        ...
        public static List<PlayerRace> GenerateRace()
        {
            ...
            string humanImgURL = AppDomain.CurrentDomain.BaseDirectory + "bin/Core/PlayerSetup/Data/Img/RaceImg/human.jpg";
            ...
            string ElfImgURL = AppDomain.CurrentDomain.BaseDirectory + "bin\\Core\\PlayerSetup\\Data\\Img\\RaceImg\\elf.jpg";
            ...
            listOfRace.Add(new PlayerRace("Dark Elf", 1, 0, 2, -2, 0, 0, darkElfHelp, ElfImgURL));
            listOfRace.Add(new PlayerRace("Dwarf", 1, 0, 2, -2, 0, 0, dwarfHelp, ElfImgURL));
            return listOfRace;
        }
